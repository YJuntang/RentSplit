...
public final class DatabaseModule_ProvideExpenseDaoFactory implements Factory<ExpenseDao> {
  ...
  public DatabaseModule_ProvideExpenseDaoFactory(Provider<RentSplitDatabase> databaseProvider) {
  ...
  public static ExpenseDao provideExpenseDao(RentSplitDatabase database) {
